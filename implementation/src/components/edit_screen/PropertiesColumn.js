        ...
        return (
            <div className="card z-depth-0 wireframe-list-link">
                <div className="card-content grey-text text-darken-3 item-card">
                    ...
                    {this.props.component.fontSize !== -1 && <span>Font Size: <input className="active center" type="text" onChange={this.changeFontSize} defaultValue={this.props.component.fontSize} ref="fontSize"/></span>}
                    ...
                    <span>Border Color: <input className="active center" type="text" onChange={this.changeBorderColor} defaultValue={this.props.component.borderColor} ref="borderColor"/></span>
                    <span>Font Color: <input className="active center" type="text" onChange={this.changeFontColor} defaultValue={this.props.component.fontColor} ref="fontColor"/></span>
